...
let modulePaths = {
 ...
 "packages/Maintanence/datastructure/services": "packages/Maintanence/datastructure/services.ddc",
 ...
 "packages/datetime_picker_formfield/datetime_picker_formfield": "packages/datetime_picker_formfield/datetime_picker_formfield.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/Maintanence/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:Maintanence/main_web_entrypoint.dart") {
          // Clear static caches.
