define(['dart_sdk', 'packages/Maintanence/main'], function(dart_sdk, packages__Maintanence__main) {
  'use strict';
  ...
  const main = packages__Maintanence__main.main;
  ...
  dart.trackLibraries("packages/Maintanence/main_web_entrypoint", {
    "package:Maintanence/main_web_entrypoint.dart": main_web_entrypoint
  }, {
